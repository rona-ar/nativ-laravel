    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('admin/master-data/dosen') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="" class="control-label">NIP</label>
                                    <input class="form-control" type="text" name="nip" id="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="gelar_depan" id="">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="" class="control-label">Gelar Belakang</label>
                                    <input class="form-control" type="text" name="gelar_belakang" id="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
